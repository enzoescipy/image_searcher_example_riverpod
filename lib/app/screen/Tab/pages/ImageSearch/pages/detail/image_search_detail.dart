...
class ImageSearchDetail extends ConsumerWidget {
  final String? id;
  const ImageSearchDetail(this.id, {super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final imageItemVOInterfaceNotifier = ref.read(VOProviderManager().imageItemVOInterfaceProvider.notifier);
    final imageItem = imageItemVOInterfaceNotifier.getSingleVO((int.parse(id ?? "-1")));
